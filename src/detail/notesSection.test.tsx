...
import { RECORDING_ID, api, conversation, detailData, installBrowserStubs, note, recording, setDetail } from "./screen.fixtures";
...
import { notes, resetScreen, say, show, transcriptShown } from "./screen.harness";
