...
export const enSettings: Partial<Record<keyof typeof csSettings, string>> = {
  ...
  "settings.archive.exportNote": "The backups sit beside the archive on this computer. Only a copy saved elsewhere survives a new disk.",
  ...
  "settings.archive.importNote": "The archive you load replaces the current one. Audio files are not part of a backup.",
