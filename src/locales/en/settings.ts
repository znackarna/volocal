...
export const enSettings: Partial<Record<keyof typeof csSettings, string>> = {
  ...
  "settings.archive.exportNote": "Saves the transcripts only, without the source recordings.",
  ...
  "settings.archive.importNote": "The archive you load replaces the current one.",
