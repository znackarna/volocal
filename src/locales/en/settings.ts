...
export const enSettings: Partial<Record<keyof typeof csSettings, string>> = {
  ...
  "settings.files.watchAutoNote":
    "Without it the application only offers new files in Archive. It doesn’t look in subfolders.",
  ...
  "settings.advanced.note":
    "Nothing here needs changing for ordinary transcription. The defaults match Whisper’s own settings.",
