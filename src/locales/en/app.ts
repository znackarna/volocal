...
export const enApp: Partial<Record<keyof typeof csApp, string>> = {
  ...
  "app.confirm.removeText": "The transcript of {title} will be deleted. The audio file on disk stays untouched.",
  "app.confirm.removeAction": "Remove",
  "app.confirm.deleteTranscriptTitle": "Delete transcript?",
  "app.confirm.deleteTranscriptText": "The text and the manual edits for {title} will be lost. The recording stays in the archive and you can transcribe it again.",
