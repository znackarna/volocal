...
export const csDetail = {
  ...
  "detail.clip.length": "{length}",
  "detail.clip.pickEnd": "Klepněte na poslední úsek výřezu",
  "detail.clip.blocks.one": "{count} úsek",
  "detail.clip.blocks.few": "{count} úseky",
  "detail.clip.blocks.many": "{count} úseku",
  "detail.clip.blocks.other": "{count} úseků",
  "detail.clip.play": "Přehrát",
  "detail.clip.save": "Uložit…",
  "detail.clip.dialogTitle": "Co z výřezu uložit?",
  "detail.clip.dialogText": "Vyříznuto od {from} do {to}.",
