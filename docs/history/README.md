...
| [2026-09-04](2026-09-04.md) | 11 | Two more cards in Co získáte?, for the two features that shipped; a one-page answer to Vít, seven layers deep, with every client name out of it; and four readers over its Czech, which left two scripts behind so the next page cannot read as a translation … |
