...
| [2026-09-02](2026-09-02.md) | 7 | The first real fill worked in the archive and stuck on screen: the fill never said `complete`. Fixed, and the setting moved into a card of its own, renamed to what it is about. |
